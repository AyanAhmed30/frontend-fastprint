...
const Carousel = () => {
  ...
  const infiniteData = [...carouselData, ...carouselData, ...carouselData, ...carouselData, ...carouselData, ...carouselData, ...carouselData ];
  ...
  // Scroll handler removed to allow free continuous scroll (no snapping)
  // const handleScroll = () => {}
  ...
  return (
    <section className="relative py-12 px-4 w-full max-w-7xl mx-auto">
      ...
      <div className="relative">
        ...
        <div className="flex w-full justify-between items-center absolute top-1/2 left-0 z-30 pointer-events-none" style={{transform: 'translateY(-50%)'}}>
