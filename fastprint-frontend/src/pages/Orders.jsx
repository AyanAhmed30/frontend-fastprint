        ...
        <div className="min-h-screen w-full bg-gradient-to-br from-[#eef4ff] to-[#fef6fb] font-sans">
          <div className="w-full h-[60px] flex items-center px-4 md:px-8 bg-gradient-to-r from-[#016AB3] via-[#0096CD] to-[#00AEDC] shadow-xl">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-white text-lg md:text-xl font-bold">Your Orders</h1>
            </div>
          </div>
            ...
            <div className="w-full max-w-lg bg-white rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl overflow-hidden">
              <div className="bg-gradient-to-br from-[#016AB3] via-[#0096CD] to-[#00AEDC] px-4 md:px-6 py-8 md:py-10 text-center relative">
                ...
                <div className="relative z-10">
                  ...
                  <h1 className="text-xl md:text-2xl font-bold text-white mb-2 md:mb-3">No Orders Yet</h1>
              ...
              <div className="px-4 md:px-6 py-4 md:py-5 bg-gray-50">
                <div className="grid grid-cols-3 gap-3 md:gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-xs md:text-sm font-medium text-gray-700">Add Projects</p>
                  </div>
                  <div className="text-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-[#016AB3]/10 rounded-full flex items-center justify-center mx-auto mb-1 md:mb-2">
                      <FaShoppingCart className="text-[#016AB3] text-sm md:text-base" />
                    </div>
                    <p className="text-xs md:text-sm font-medium text-gray-700">Review Cart</p>
                  </div>
                  <div className="text-center">
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-[#016AB3]/10 rounded-full flex items-center justify-center mx-auto mb-1 md:mb-2">
                      <FaCheckCircle className="text-[#016AB3] text-sm md:text-base" />
                    </div>
                    <p className="text-xs md:text-sm font-medium text-gray-700">Place Order</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
            <div className="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm font-semibold text-gray-500 uppercase tracking-wider">Items in Cart</p>
                  <p className="text-2xl md:text-4xl font-bold text-[#016AB3] mt-1 md:mt-2">{projects.length}</p>
            ...
            <div className="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm font-semibold text-gray-500 uppercase tracking-wider">Total Value</p>
                  <p className="text-2xl md:text-4xl font-bold text-emerald-600 mt-1 md:mt-2">$0.00</p>
          ...
          <div className="bg-white shadow-xl md:shadow-2xl rounded-2xl md:rounded-3xl overflow-hidden border border-gray-100">
            ...
            <div className="bg-gradient-to-r from-[#016AB3] via-[#0096CD] to-[#00AEDC] px-4 md:px-8 py-6 md:py-8 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  <h1 className="text-white text-xl md:text-2xl font-bold mb-1 md:mb-2">Your Orders</h1>
                  <p className="text-blue-100 text-xs md:text-sm">Review and manage your cart items</p>
                </div>
            ...
            {/* Table for medium+ screens, cards for small screens */}
                    ...
                    <tr>
                      <td colSpan="4" className="px-6 md:px-8 py-12 md:py-16 text-center">
                        <div className="flex flex-col items-center justify-center text-gray-500">
                          ...
                          <p className="text-base md:text-lg font-semibold text-gray-700">No orders found</p>
              ...
              {filteredProjects.length > 0 ? (
                <div className="divide-y divide-gray-200">
                  {filteredProjects.map((project) => (
                    <div key={project.id} className="p-4 hover:bg-gradient-to-r hover:from-[#F8FAFF] hover:to-[#F0F7FF] transition-all duration-300">
