...
const OPTIONS_CONFIG = {
  interiorColor: [
    ...
    { name: "Premium Black & White", img: PremiumBlackandWhite, dbName: "Premium Black & White", price: 0.0325 },
  ...
  paperType: [
    ...
    { name: "70# White-Uncoated", img: Whitecoatedd, dbName: "70# White-Uncoated", price: 0.02 },
    ...
    <>
      ...
      <div className="w-full min-h-screen px-4 sm:px-6 lg:px-8 py-8 flex flex-col xl:flex-row gap-6 xl:gap-8">
        <div className="w-full xl:w-3/5 bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6 lg:p-8 rounded-2xl">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-[#2A428C]">Year Book</h2>
