    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="mt-8 bg-gray-50 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className={`p-4 rounded-lg ${settings.stripe_enabled ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
            <div className="flex items-center">
          ...
          <div className={`p-4 rounded-lg ${settings.paypal_enabled ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
            <div className="flex items-center">
